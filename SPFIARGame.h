 ...
 * 	 Summary:
 *
 * This file is a container that represents a classic connect-4 game, a two players 6 by 7
...
#define SP_FIAR_GAME_FULL_ROW_LENGTH 17
#define SP_FIAR_GAME_PLAYER_1_SYMBOL 'X' // this player is the user
#define SP_FIAR_GAME_PLAYER_2_SYMBOL 'O' // this player is the computer
